...
public class FrenchPhoneticTest {
    ...
    @Test
    public void testAudre() throws EncoderException {
        FrenchPhonetic frenchPhonetic = new FrenchPhonetic();
    ...
    @Test
    public void testAudrey() throws EncoderException {
        FrenchPhonetic frenchPhonetic = new FrenchPhonetic();
    ...
    @Test
    public void testPiere() throws EncoderException {
        FrenchPhonetic frenchPhonetic = new FrenchPhonetic();
    ...
    @Test
    public void test_avec_espace() throws EncoderException {
        FrenchPhonetic frenchPhonetic = new FrenchPhonetic();
    ...
    @Test
    public void test_avec_espace_LE_GALL() throws EncoderException {
        FrenchPhonetic frenchPhonetic = new FrenchPhonetic();
        String encode = frenchPhonetic.encode("LE GALL");
        Assertions.assertThat(encode).isEqualTo("L2GAL");
    }

    @Ignore
    @Test
    public void testDiff() throws EncoderException {
        FrenchPhonetic frenchPhonetic = new FrenchPhonetic();
        String encode = frenchPhonetic.encode("MELA");
        System.out.println("MELA => " + encode);
        encode = frenchPhonetic.encode("CARLES");
        System.out.println("CARLES => " + encode);
        encode = frenchPhonetic.encode("KAHYA");
        System.out.println("KAHYA => " + encode);
    }
